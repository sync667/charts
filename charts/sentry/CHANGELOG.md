...
## [27.0.0](https://github.com/sync667/charts/compare/sentry-v26.19.0...sentry-v27.0.0) (2025-06-20)
...
* add `imagePullSecrets` option to the metrics deployment ([#1722](https://github.com/sync667/charts/issues/1722)) ([3463781](https://github.com/sync667/charts/commit/3463781b9f1dcba2350e8d6bef9aa4dfc9e12083))
...
* add clickhouse ssl config ([#1671](https://github.com/sync667/charts/issues/1671)) ([a48f91c](https://github.com/sync667/charts/commit/a48f91c8218cb9f9363c249a02407e776f5ced1c))
...
* add custom labels for ingress ([#1672](https://github.com/sync667/charts/issues/1672)) ([712a469](https://github.com/sync667/charts/commit/712a4696a2d163ee83baad61453e7a3fa2da4f3d))
...
* add Kafka topics from upstream projects (Sentry and Snuba) for version 24.12.2 ([#1678](https://github.com/sync667/charts/issues/1678)) ([cf696b7](https://github.com/sync667/charts/commit/cf696b75d1c13b9f1af3388c3d818b8fdffee71b))
...
* Add monitorsClockTasks and monitorsClockTick ([#1690](https://github.com/sync667/charts/issues/1690)) ([1fe663d](https://github.com/sync667/charts/commit/1fe663d345c9e420c901f25dc306e0e27549d905))
* add more values for sentry ([#1765](https://github.com/sync667/charts/issues/1765)) ([cdd0905](https://github.com/sync667/charts/commit/cdd0905581c01309caee734e9f778add0cf3cf4c))
...
* Sentry 24.11.2 ([#1640](https://github.com/sync667/charts/issues/1640)) ([70d0710](https://github.com/sync667/charts/commit/70d0710d0f063d346eb0743ef2745ce40d57c764))
...
* update appVersion to 25.1.0 and add topic ([#1686](https://github.com/sync667/charts/issues/1686)) ([31e7368](https://github.com/sync667/charts/commit/31e73689f25ef1ab4d17e6f41a16d91b62a4d475))
* update appVersion to 25.2.0 ([#1713](https://github.com/sync667/charts/issues/1713)) ([8c5fc21](https://github.com/sync667/charts/commit/8c5fc210556bd6b7f604709ccfc9aa30ea1cd0b8))
* update appVersion to 25.3.0 ([#1740](https://github.com/sync667/charts/issues/1740)) ([9ed13bb](https://github.com/sync667/charts/commit/9ed13bbd7b604681ee8079bb53d427376552a40a))
...
* update sentry appVersion to v25.4.0 ([#1754](https://github.com/sync667/charts/issues/1754)) ([b34f26d](https://github.com/sync667/charts/commit/b34f26d95b29970152b33c45dbb9ee94fe3a5515))
* update sentry appVersion to v25.5.1 ([#1782](https://github.com/sync667/charts/issues/1782)) ([9e9a05f](https://github.com/sync667/charts/commit/9e9a05f1930bd3e58c4fa94eefc5dd78ca9c72e3))
* update Sentry chart to appVersion 24.10.0 ([#1652](https://github.com/sync667/charts/issues/1652)) ([72f61ff](https://github.com/sync667/charts/commit/72f61ff7ae1a26d11865cec083861041d94e029d))
...
* add Kafka topics from upstream projects (Sentry and Snuba) for version 24.9.0 ([#1647](https://github.com/sync667/charts/issues/1647)) ([cac64cf](https://github.com/sync667/charts/commit/cac64cff98fe9b11a29c83e5f562086ad5f4e00a))
* Add missing global sidecar to ingestConsumerTransactions deployment ([#1705](https://github.com/sync667/charts/issues/1705)) ([5a9f5d7](https://github.com/sync667/charts/commit/5a9f5d762dfa693374f598fd8eec9754cc17ad6c))
...
* clickhouse env. ([#1786](https://github.com/sync667/charts/issues/1786)) ([3f13f00](https://github.com/sync667/charts/commit/3f13f00882c339f65500c50a96272db41be5b365))
* clickhouse replicas 1 ([d789562](https://github.com/sync667/charts/commit/d789562cbde4371b0057272976a981f66229ca50))
* clickhouse-chart for correct placement of internal_replication ([#1662](https://github.com/sync667/charts/issues/1662)) ([a3e82be](https://github.com/sync667/charts/commit/a3e82be0f081e4e548658d7acecdcb761a57b469))
...
* fix typo in value of argument '--consumer-group' for ([#1758](https://github.com/sync667/charts/issues/1758)) ([15d1811](https://github.com/sync667/charts/commit/15d1811b088b26f20215970d53622e59d4973728))
* global nodeSelector config option not applying to cleanup cron job ([#1654](https://github.com/sync667/charts/issues/1654)) ([4e764b5](https://github.com/sync667/charts/commit/4e764b5ab006682b609571ae0b9f06014103e194))
...
* missing block in ingest-consumer-transactions ([#1680](https://github.com/sync667/charts/issues/1680)) ([424f50f](https://github.com/sync667/charts/commit/424f50f7f4c5572b13c68659bb91bdaba50c3e1e))
...
* **nginx:** _assets should rewrite to _static/sentry/dist ([#1719](https://github.com/sync667/charts/issues/1719)) ([be4d8c5](https://github.com/sync667/charts/commit/be4d8c5619b4fe42e7c47c6f58ea8513e0cff284))
...
* rollback to 24.12.1 ([aa6cad8](https://github.com/sync667/charts/commit/aa6cad88fe0f2e0594aff7325d33f3ed643f250a))
* set replication factor for kafka stability ([#1606](https://github.com/sync667/charts/issues/1606)) ([7ebb1f6](https://github.com/sync667/charts/commit/7ebb1f636984485dd646eb482978bde3a4f3da36))
...
* update readme.md with latest configuration values ([#1666](https://github.com/sync667/charts/issues/1666)) ([070b19f](https://github.com/sync667/charts/commit/070b19f11c95bd294d9c5419ca5d7d17dfa092fa))
